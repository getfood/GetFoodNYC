...
namespace GetFoodNYC
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        {
            InitializeComponent();
            loadFeedButton_Click(null, null);
        ...
        {
            System.Diagnostics.Debug.WriteLine("[DEBUG]" + e.ToString() + "|" + e.Error.ToString());
        }
        ...
        private void loadFeedButton_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            webClient.DownloadStringAsync(new System.Uri("http://www.getfoodnyc.info/feed"));
        }
